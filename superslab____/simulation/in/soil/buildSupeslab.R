...
wpath <- "/Users/ecor/Dropbox/projects/Intercomparison/superslab/simulation"


soilprop_tmp <- read.table(paste(wpath,"in/soil/soilprop_tmp.txt",sep="/"),sep=",",header=TRUE) 
#######
...
write.table(soilprop_tmp,paste(wpath,"in/soil/soilprop.txt",sep="/"),sep=",",quote=FALSE,row.names=FALSE) 
